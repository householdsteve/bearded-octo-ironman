          ...
          <?php 
           ...
           <div class="clear"></div>
             <div class="one_fifth fulldetails"> 
                ...
                <p class="smalldetails"><a href=" <?php comments_link(); ?> "><?php comments_number( __('No Comments', 'framework'), __('One Comment', 'framework'), __('% Comments', 'framework') ); ?></a>  
                    <br />
                    <?php _e('By', 'framework'); ?>
                    <?php the_author_link(); ?>
                </p>
            ...
            <div class="mobiledetails">
                     <p>
					 <?php _e('On ', 'framework'); the_time('d'); ?>, <?php the_time('M'); ?>  <?php the_time('Y'); ?> | <a href=" <?php comments_link(); ?> ">
                   	 <?php comments_number( __('No Comments', 'framework'), __('One Comment', 'framework'), __('% Comments', 'framework') ); ?>
                     </a> |  <?php _e('In ', 'framework'); echo get_the_term_list( $post->ID, 'sort', '', ' ', '' ); ?> | <?php _e('By ', 'framework'); the_author_link(); ?>
                     </p> 
             </div>
