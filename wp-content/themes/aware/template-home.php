...
<?php /*if (($ajaxtop = get_option('of_ajax_position')) == 'Top') : ' */?>
<!-- Load Container Post
================================================== -->
...
================================================== -->
    ...
    <div class="slideshowpreload"></div>
        <?php $loop = new WP_Query( array( 'post_type' => 'portfolio', 'posts_per_page' => 30 ) ); $counter = 1;
...
<div id="ajaxcontainer">
    <div class="container clearfix" id="ajaxouter">
        <div id="ajaxinner" data-url="'.get_template_directory_uri().'/functions/ajax-open.php"></div>
    </div>
</div><?php /* endif; */ ?> -->
<!-- Home Content Area
================================================== -->
...
<div class="container clearfix homecontent">
    ...
    <div class="four columns widget news-widget-item">
        ...
        <h4 class="posttitlee"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php printf(__('Permanent Link to %s', 'framework'), get_the_title()); ?>">
            <?php the_title(); ?>
            </a></h4>
